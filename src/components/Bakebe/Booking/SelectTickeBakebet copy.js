    ...
    <div>
      ...
      <div class="py-8 px-4 bg-white  rounded-b-md fd-cl group-hover:opacity-25">
        ...
        <span class="block text-gray-600 text-sm">
          ...
          bibendum faucibus purus eget cursus. Proin enim ante, scelerisque vel
          sem sit amet, ultrices mollis risus. Praesent justo felis, ullamcorper
          a cursus sed, condimentum at dui.
        </span>
      </div>
    </div>
