...
export default function Topbar() {
  ...
  return (
    <div className='relative flex w-full py-2 pr-2 lg:px-8 justify-between bg-[#212121]'>
        <div className='flex w-1/5 md:w-1/3 pl-2 justify-center items-center border-r-2 border-white'>
      ...
      <div className='flex w-3/4 lg:pl-6 sm:w-3/5 w-full px-1 gap-1 items-center'>
