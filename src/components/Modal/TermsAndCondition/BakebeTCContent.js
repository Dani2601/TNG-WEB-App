...
export default function BakebeTCContent() {
  return (
    ...
    <ul className="list-disc list-inside flex flex-col gap-4">
            ...
            accommodate is only 6-8 years old, but will depend on 
            ...
            <li className='text-sm'>
                ...
                ONCE and that will also be subjected to a PHP 300 
                rescheduling fee for slot availability. After more than 
                seven (7) days of your booked date, attempts to 
