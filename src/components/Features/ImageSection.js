    ...
    <div className='flex flex-col font-quicksand'>
        <div className='flex flex-col md:flex-row w-full md:h-[512px]'>
            ...
            <div className='flex flex-col justify-center items-center py-4 w-full md:w-1/2 bg-[#a161ad]'>
                ...
                <button onClick={handleNavigate} className='hoverEffects border-2 border-[#8d0b0b] rounded-full px-16 py-2 bg-white mt-[-20px] text-sm tracking-widest text-[#8d0b0b]'>BOOK NOW</button>
            </div>
        </div>
        <div className='flex flex-col md:flex-row w-full md:h-[512px]'>
